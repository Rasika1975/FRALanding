          ...
          <div className="hidden md:flex items-center space-x-8">
            {navItems.map((item, index) => (
              <motion.a
                ...
                className="text-sm text-zinc-300 hover:text-lime-400 transition-colors duration-200 relative group"
              >
                {item.name}
        ...
        >
          <div className="px-4 py-4 space-y-4">
            {navItems.map((item) => (
              <a
                key={item.name}
                href={item.href} className="block text-sm text-zinc-300 hover:text-lime-400 transition-colors duration-200"
