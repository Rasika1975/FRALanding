        ...
        >
          ...
          <div className="relative bg-zinc-950/70 backdrop-blur-sm border border-lime-400/20 rounded-3xl p-12 md:p-16">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-6">
              <Link
                to="/signup"
                className="group bg-gradient-to-r from-lime-400 to-lime-300 text-zinc-950 px-10 py-4 rounded-full font-semibold text-lg hover:shadow-2xl hover:shadow-lime-400/25 transition-all duration-300 hover:scale-105 flex items-center"
              >
                Start Free Trial
                <ChevronRight className="ml-2 w-5 h-5 group-hover:translate-x-1 transition-transform duration-300" />
              </Link>

              <button className="text-lime-400 hover:text-zinc-100 transition-colors duration-200 font-medium">
                Schedule a Demo
              </button>
            </div>
            ...
            <div className="mt-12 pt-8 border-t border-zinc-700">
              <p className="text-sm text-zinc-500 mb-4">Trusted by leading companies worldwide</p>
              <div className="flex items-center justify-center space-x-8 opacity-60">
                <div className="text-zinc-500 font-semibold">TechStart</div>
                <div className="text-zinc-500 font-semibold">AI Solutions</div>
                <div className="text-zinc-500 font-semibold">FinanceFlow</div>
                <div className="text-zinc-500 font-semibold">InnovateHub</div>
              </div>
            </div>
          </div>
        </motion.div>
